...
nouns = load_word_set("data/pos/core_pos/nouns.csv")
verbs = load_word_set("data/pos/core_pos/expanded_verbs.csv")
adjectives = load_word_set("data/pos/core_pos/adjectives.csv")
adverbs = load_word_set("data/pos/core_pos/adverbs.csv")

auxiliary = load_word_set("data/pos/directors/auxiliary.csv")
compositions = load_word_set("data/pos/directors/compositions.csv")
conjunctions = load_word_set("data/pos/directors/conjunctions.csv")
determiners = load_word_set("data/pos/directors/determiners.csv")
existential_determiners = load_word_set("data/pos/directors/existential_determiners.csv")
modifiers = load_word_set("data/pos/directors/modifiers.csv")
negative_quantifiers = load_word_set("data/pos/directors/negative_quantifiers.csv")
prepositions = load_word_set("data/pos/directors/prepositions.csv")
universal_determiners = load_word_set("data/pos/directors/universal_determiners.csv")
pronouns = load_word_set("data/pronouns.csv")
possessive_determiners = load_word_set("data/posessive_det.csv")
